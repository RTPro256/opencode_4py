...
| [RAG_ERROR_PREVENTION_AUDIT.md](RAG_ERROR_PREVENTION_AUDIT.md) | RAG error pattern audit | Active |
...
|------|-------------|--------|
| [CODE_IMPROVEMENT_PLAN.md](../plans/CODE_IMPROVEMENT_PLAN.md) | Code quality improvements | In Progress |
| [TESTING_PLAN.md](../plans/TESTING_PLAN.md) | Testing strategy and coverage | Active |
| [FOR_TESTING_PLAN.md](../plans/FOR_TESTING_PLAN.md) | Testing infrastructure | Active |
| [DOCUMENTATION_PLAN.md](../plans/DOCUMENTATION_PLAN.md) | Documentation strategy | Active |
| [PRIVACY_FIRST_RAG_PLAN.md](../plans/PRIVACY_FIRST_RAG_PLAN.md) | Privacy-focused RAG | Active |
| [PROJECT_ORGANIZATION_PLAN.md](../plans/PROJECT_ORGANIZATION_PLAN.md) | Project structure | Complete |
| [PROJECT_REVIEW_FINDINGS.md](../plans/PROJECT_REVIEW_FINDINGS.md) | Review findings and recommendations | Active |
| [COMPREHENSIVE_PROJECT_REVIEW_PLAN.md](../plans/COMPREHENSIVE_PROJECT_REVIEW_PLAN.md) | Comprehensive review plan | Active |
| [SIMPLIFIED_TROUBLESHOOTING_UX_PLAN.md](../plans/SIMPLIFIED_TROUBLESHOOTING_UX_PLAN.md) | UX improvements | Active |
| [UPDATE_UPGRADE_TROUBLESHOOTING_SUBPLAN.md](../plans/UPDATE_UPGRADE_TROUBLESHOOTING_SUBPLAN.md) | Troubleshooting updates | Active |

### Archived Plans

| Plan | Description | Status |
|------|-------------|--------|
| [MULTI_MODEL_IMPLEMENTATION_PLAN.md](../plans/archive/MULTI_MODEL_IMPLEMENTATION_PLAN.md) | Multi-model infrastructure | Archived |
| [PROJECT_INTEGRATION_PLAN.md](../plans/archive/PROJECT_INTEGRATION_PLAN.md) | Project integration | Archived |
| [MIGRATION_PLAN.md](../plans/archive/MIGRATION_PLAN.md) | TypeScript migration | Archived |
| [INTEGRATION_POSTMORTEM.md](../plans/archive/INTEGRATION_POSTMORTEM.md) | Integration lessons | Archived |

> See [`plans/archive/README.md`](../plans/archive/README.md) for archive details.
