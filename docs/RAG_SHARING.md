...
Error documents should follow this format:

```markdown
# Error: TUI Stalls at "Thinking..."

## Error ID
ERR-001

## Symptoms
- TUI shows "Thinking..." indefinitely
...
3. Check logs: `opencode debug log`

## Solution
1. Start Ollama: `ollama serve`
2. Pull required model: `ollama pull qwen3-coder:30b`
3. Restart OpenCode
...
## Related Errors
- ERR-002: Model not found
- ERR-003: Ollama connection refused
```
...
- [RAG Best Practices](BEST_PRACTICE_FOR_RAG.md)
- [Troubleshooting Guide](../RAG/troubleshooting/README.md)
- [Debug Commands](../src/opencode/README.md)
