...
> **Navigation:**
> - **Previous:** [TARGET_PROJECT_SYNC_PLAN.md](TARGET_PROJECT_SYNC_PLAN.md) - Target project synchronization
> - **Next:** [INTEGRATION_STATUS.md](INTEGRATION_STATUS.md) - ComfyUI integration
...
| `FOR_TESTING_UPDATE_PLAN.md` | Troubleshooting procedures | ✅ Required |
...
cp plans/FOR_TESTING_UPDATE_PLAN.md "$TARGET_PLANS/"
...
- Should receive a copy of relevant sub-plans (e.g., `FOR_TESTING_UPDATE_PLAN.md`)
...
- [ ] Copy `FOR_TESTING_UPDATE_PLAN.md` to `{target}/plans/`
...
**Document:** [`FOR_TESTING_UPDATE_PLAN.md`](./FOR_TESTING_UPDATE_PLAN.md)
...
cp plans/FOR_TESTING_UPDATE_PLAN.md [TARGET_PYTHON]/Lib/site-packages/opencode/plans/

# Example for ComfyUI integration:
cp plans/FOR_TESTING_UPDATE_PLAN.md ComfyUI_windows_portable/python_embeded/Lib/site-packages/opencode/plans/
```
